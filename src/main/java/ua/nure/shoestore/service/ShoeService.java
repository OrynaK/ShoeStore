...
public class ShoeService {
    ...
    public List<ShoeCardDTO> getShoes() {
        ...
        for (Shoe s : shoeDAO.findAll()) {
            ShoeCardDTO shoeCard = new ShoeCardDTO(s.getPrice(), s.getName(), "/src/main/webapp/my-shoestore/images/" + shoeDAO.imageNameByImageId((long) s.getImageId()) );
...
//    }
    ...
    public Long addShorWithImage(ShoeDTO shoeDTO, String path, String name){
